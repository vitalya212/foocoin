...
#if defined(NDEBUG)
# error "Foocoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x24b6a8317fc1201d1525dab4a1a8986bfed6e62c59e7d8f59ee423496ef213cb");
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Foocoin: 1 day
static const int64 nTargetSpacing = 2 * 60; // Foocoin: 2 minute
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x24b6a8317fc1201d1525dab4a1a8986bfed6e62c59e7d8f59ee423496ef213cb");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Spiegel, 2014/05/24 Real Madrid ist Champions-League-Sieger 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1400967277;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2770302;
        ...
        assert(block.hashMerkleRoot == uint256("0xe86e61c5cd0da7811d300aec2d8e9d5913b34c8c4491baed6584b7ab3a9190d0"));
        /*
...
void static FoocoinMiner(CWallet *pwallet)
{
    printf("FoocoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("foocoin-miner");
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&FoocoinMiner, pwallet));
}
